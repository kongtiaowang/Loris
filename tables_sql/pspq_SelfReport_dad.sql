CREATE TABLE `pspq_SelfReport_dad` (
    ...
    `q4_hard_avoid_sidetrack` enum('1_very_rarely','2_rarely','3_occasionally','4_somewhat_often','5_often','6_very_often','na') default NULL,
    ...
    `q25_connecting_people` enum('1_very_rarely','2_rarely','3_occasionally','4_somewhat_often','5_often','6_very_often','na') default NULL,
    ...
    `q29_longpauses_conversations` enum('1_very_rarely','2_rarely','3_occasionally','4_somewhat_often','5_often','6_very_often','na') default NULL,
