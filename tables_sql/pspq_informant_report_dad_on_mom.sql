CREATE TABLE `pspq_informant_report_dad_on_mom` (
...
`informant_child` enum('mother','father','stepmother','stepfather','other') default NULL,
`informant_child_other` varchar(255) default NULL,
