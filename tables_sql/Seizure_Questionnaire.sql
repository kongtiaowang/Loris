CREATE TABLE `Seizure_Questionnaire` (
    ...
    `p2_1_duration` text default NULL,
    ...
    `p2_2_duration` text default NULL,
    ...
    `p3_3_duration` text default NULL,
    ...
    `p3_4_duration` text default NULL,
    ...
    `p3_5_duration` text default NULL,
    ...
    `p3_6_duration` text default NULL,
    ...
    `p3_7_duration` text default NULL,
