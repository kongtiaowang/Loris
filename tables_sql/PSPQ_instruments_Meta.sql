INSERT INTO test_names (Test_name, Full_name, Sub_group, IsDirectEntry) VALUES ('pspq_SelfReport_dad', 'PSPQ Self (Personality Styles & Preferences) - Dad - Survey', '13','1');
...
INSERT INTO test_names (Test_name, Full_name, Sub_group, IsDirectEntry) VALUES ('pspq_SelfReport_mom', 'PSPQ Self (Personality Styles & Preferences) - Mom - Survey', '13','1');
...
INSERT INTO test_names (Test_name, Full_name, Sub_group, IsDirectEntry) VALUES ('pspq_InformantReport_dad_on_mom', "PSPQ Informant (Personality Styles & Preferences) - Dad on Mom - Survey", '13','1');
...
INSERT INTO test_names (Test_name, Full_name, Sub_group, IsDirectEntry) VALUES ('pspq_InformantReport_mom_on_dad', "PSPQ Informant (Personality Styles & Preferences) - Mom on Dad - Survey", '13','1');
