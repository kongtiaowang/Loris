...
(
    ...
    `a3`                                                 enum ('0','1','2','3','8','not_answered') DEFAULT NULL,
    `a4`                                                 enum ('0','1','2','3','8','not_answered') DEFAULT NULL,
    `a5`                                                 enum ('0','1','2','3','8','not_answered') DEFAULT NULL,
    `a6`                                                 enum ('0','1','2','3','8','not_answered') DEFAULT NULL,
    `a7`                                                 enum ('0','1','2','3','not_answered') DEFAULT NULL,
    `a8`                                                 enum ('0','1','2','3','8','not_answered') DEFAULT NULL,
    `a9`                                                 enum ('0','1','2','3','8','not_answered') DEFAULT NULL,
    `b1`                                                 enum ('0','1','2','3','not_answered') DEFAULT NULL,
    `b2`                                                 enum ('0','1','2','3','8','not_answered') DEFAULT NULL,
    `b3`                                                 enum ('0','1','2','3','8','not_answered') DEFAULT NULL,
    ...
    `b13`                                                enum ('0','1','2','3','not_answered') DEFAULT NULL,
    `b14`                                                enum ('0','1','2','3','not_answered') DEFAULT NULL,
    `b15`                                                enum ('0','1','2','3','not_answered') DEFAULT NULL,
    `b16a`                                               enum ('0','1','2','3','7','not_answered') DEFAULT NULL,
    `b16b`                                               enum ('0','1','2','3','7','8','not_answered') DEFAULT NULL,
    ...
    `e3`                                                 enum ('0','1','2','3','not_answered') DEFAULT NULL,
    `e4`                                                 enum ('0','1','2','3','not_answered') DEFAULT NULL,
    ...
    `b13_weighted`                                       varchar(255)          DEFAULT NULL,
    `b14_weighted`                                       varchar(255)          DEFAULT NULL,
    `b15_weighted`                                       varchar(255)          DEFAULT NULL,
    `b16b_weighted`                                      varchar(255)          DEFAULT NULL,
    `b18_weighted`                                       varchar(255)          DEFAULT NULL,
...
VALUES ('ADOS2_Toddler_Module', 'ADOS2_Toddler_Module_page1', 'Sections A-B', 1);
INSERT INTO instrument_subtests (Test_name, Subtest_name, Description, Order_number)
VALUES ('ADOS2_Toddler_Module', 'ADOS2_Toddler_Module_page2', 'Sections C-E', 2);
