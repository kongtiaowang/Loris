CREATE TABLE `SRS2_SchoolAge_Fxs_Subject` (
...
`DSM5_SCI_score` varchar(255) default NULL,
`DSM5_SCI_T_score` varchar(255) default NULL,
`DSM5_RRB_score` varchar(255) default NULL,
`DSM5_RRB_T_score` varchar(255) default NULL,
`Awr_score` varchar(255) default NULL,
`Awr_T_score` varchar(255) default NULL,
`Cog_score` varchar(255) default NULL,
`Cog_T_score` varchar(255) default NULL,
`Com_score` varchar(255) default NULL,
`Com_T_score` varchar(255) default NULL,
`Mot_score` varchar(255) default NULL,
...
`q11_has_selfconfidence` enum('1_not_true','2_sometimes_true','3_often_true','4_almost_always_true','refused_dontknow') default NULL,
...
`lorisSubHeader1` varchar(255) default NULL,
...
`q21_imitate_actions` enum('1_not_true','2_sometimes_true','3_often_true','4_almost_always_true','refused_dontknow') default NULL,
...
`q36_difficulty_relating_adults` enum('1_not_true','2_sometimes_true','3_often_true','4_almost_always_true','refused_dontknow') default NULL,
`q37_difficulty_relating_peers` enum('1_not_true','2_sometimes_true','3_often_true','4_almost_always_true','refused_dontknow') default NULL,
...
`q43_separates_easily` enum('1_not_true','2_sometimes_true','3_often_true','4_almost_always_true','refused_dontknow') default NULL,
`q44_chains_causation` enum('1_not_true','2_sometimes_true','3_often_true','4_almost_always_true','refused_dontknow') default NULL,
...
`q47_laugh_inappropriately` enum('1_not_true','2_sometimes_true','3_often_true','4_almost_always_true','refused_dontknow') default NULL,
`q48_goodsense_humor` enum('1_not_true','2_sometimes_true','3_often_true','4_almost_always_true','refused_dontknow') default NULL,
`q49_wellat_tasks` enum('1_not_true','2_sometimes_true','3_often_true','4_almost_always_true','refused_dontknow') default NULL,
...
`q57_gets_teased` enum('1_not_true','2_sometimes_true','3_often_true','4_almost_always_true','refused_dontknow') default NULL,
...
`q63_touching_unusual` enum('1_not_true','2_sometimes_true','3_often_true','4_almost_always_true','refused_dontknow') default NULL,
...
INSERT INTO test_names(Test_name, Full_name, Sub_Group, isDirectEntry) VALUES('SRS2_SchoolAge_Fxs_Subject', "SRS-2 SA (Social Responsiveness Scale – School Age) - FXS Subject - Survey", 1, 1);
INSERT INTO instrument_subtests (Test_name, Subtest_name, Description, Order_number) VALUES ('SRS2_SchoolAge_Fxs_Subject','SRS2_SchoolAge_Fxs_Subject_page1', "Page 1", 1);
INSERT INTO instrument_subtests (Test_name, Subtest_name, Description, Order_number) VALUES ('SRS2_SchoolAge_Fxs_Subject','SRS2_SchoolAge_Fxs_Subject_page2', "Page 2", 2);
INSERT INTO instrument_subtests (Test_name, Subtest_name, Description, Order_number) VALUES ('SRS2_SchoolAge_Fxs_Subject','SRS2_SchoolAge_Fxs_Subject_page3', "Page 3", 3);
INSERT INTO instrument_subtests (Test_name, Subtest_name, Description, Order_number) VALUES ('SRS2_SchoolAge_Fxs_Subject','SRS2_SchoolAge_Fxs_Subject_page4', "Page 4", 4);

INSERT INTO survey_test_battery (Test_name, Active, SubprojectID, Visit_label) VALUES ('SRS2_SchoolAge_Fxs_Subject', DEFAULT, 4, 'VSA');
INSERT INTO survey_test_battery (Test_name, Active, SubprojectID, Visit_label) VALUES ('SRS2_SchoolAge_Fxs_Subject', DEFAULT, 5, 'VSA');
INSERT INTO survey_test_battery (Test_name, Active, SubprojectID, Visit_label) VALUES ('SRS2_SchoolAge_Fxs_Subject', DEFAULT, 7, 'VSA');
INSERT INTO survey_test_battery (Test_name, Active, SubprojectID, Visit_label) VALUES ('SRS2_SchoolAge_Fxs_Subject', DEFAULT, 4, 'VSA-CVD');
INSERT INTO survey_test_battery (Test_name, Active, SubprojectID, Visit_label) VALUES ('SRS2_SchoolAge_Fxs_Subject', DEFAULT, 5, 'VSA-CVD');
INSERT INTO survey_test_battery (Test_name, Active, SubprojectID, Visit_label) VALUES ('SRS2_SchoolAge_Fxs_Subject', DEFAULT, 7, 'VSA-CVD');
