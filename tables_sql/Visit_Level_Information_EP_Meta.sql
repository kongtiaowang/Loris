INSERT INTO test_names (Test_name, Full_name, Sub_Group, isDirectEntry) VALUES ('Visit_Level_Information_EP', "Visit Level Information - EP", 1, 0);
INSERT INTO instrument_subtests (Test_name, Subtest_name, Description, Order_number) VALUES ('Visit_Level_Information_EP','Visit_Level_Information_EP_page1', "Page 1", 1);
...
-- Control, 3
INSERT INTO test_battery (Test_name, AgeMinDays, AgeMaxDays, Active, Stage, SubprojectID, Visit_label, CenterID) VALUES ('Visit_Level_Information_EP', '0', '0', 'Y', 'Visit', 3, 'V06', NULL);
...
INSERT INTO test_battery (Test_name, AgeMinDays, AgeMaxDays, Active, Stage, SubprojectID, Visit_label, CenterID) VALUES ('Visit_Level_Information_EP', '0', '0', 'Y', 'Visit', 3, 'VSA-CVD', NULL);