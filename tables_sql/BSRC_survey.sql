CREATE TABLE `BSRC_survey` (
    ...
    `child_enrollment_speech_language_therapy` varchar(128) default NULL,
    `child_enrollment_occupational_therapy` varchar(128) default NULL,
    `child_enrollment_physical_therapy` varchar(128) default NULL,
    `child_enrollment_comprehensive_behavioral` varchar(128) default NULL,
    `child_enrollment_other` varchar(128) default NULL,
