...
-- --------------------------------------------
CREATE TABLE Vineland_3_Proband LIKE Vineland_SA;

INSERT INTO test_names (Test_name, Full_name, Sub_group, TestExpert, IsDirectEntry)
    SELECT 'Vineland_3_Proband', 'Vineland 3 - Proband (Vineland Adaptive Behavior Scales-3rd Edition - Proband)', tn.Sub_group, tn.TestExpert, tn.IsDirectEntry
    FROM test_names tn
