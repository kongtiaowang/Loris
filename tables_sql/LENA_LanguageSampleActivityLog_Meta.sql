...
INSERT INTO test_battery (Test_name, AgeMinDays, AgeMaxDays, Active, Stage, SubprojectID, Visit_label, CenterID) VALUES ('LENA_LanguageSampleActivityLog', '0', '0', 'Y', 'Visit', 19, 'V12-CVD', NULL);
INSERT INTO test_battery (Test_name, AgeMinDays, AgeMaxDays, Active, Stage, SubprojectID, Visit_label, CenterID) VALUES ('LENA_LanguageSampleActivityLog', '0', '0', 'Y', 'Visit', 18, 'V18-CVD', NULL);
INSERT INTO test_battery (Test_name, AgeMinDays, AgeMaxDays, Active, Stage, SubprojectID, Visit_label, CenterID) VALUES ('LENA_LanguageSampleActivityLog', '0', '0', 'Y', 'Visit', 19, 'V18-CVD', NULL);
