...
ALTER TABLE ADULT_SELF_REPORT ADD COLUMN q_56_d_description_status enum('not_answered') default NULL AFTER q_56_d_description;
ALTER TABLE ADULT_SELF_REPORT ADD COLUMN question_56_e enum('not_true','sometimes','very_true') default NULL AFTER q_56_d_description_status;
