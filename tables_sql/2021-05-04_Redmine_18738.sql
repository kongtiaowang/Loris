...
ALTER TABLE pspq_InformantReport_dad_on_mom ADD `aloof_score` varchar(255) default NULL AFTER `respondent_gender`;
ALTER TABLE pspq_InformantReport_dad_on_mom ADD `prs_score` varchar(255) default NULL AFTER `aloof_score`;
ALTER TABLE pspq_InformantReport_dad_on_mom ADD `rigid_score` varchar(255) default NULL AFTER `prs_score`;
ALTER TABLE pspq_InformantReport_dad_on_mom ADD `total_score` varchar(255) default NULL AFTER `rigid_score`;

UPDATE instrument_subtests SET Description = 'Page 1', Subtest_name = 'pspq_InformantReport_dad_on_mom_page1' WHERE Test_name = 'pspq_InformantReport_dad_on_mom' AND Order_number = 1;
UPDATE instrument_subtests SET Description = 'Page 2', Subtest_name = 'pspq_InformantReport_dad_on_mom_page2' WHERE Test_name = 'pspq_InformantReport_dad_on_mom' AND Order_number = 2;
UPDATE instrument_subtests SET Description = 'Page 3', Subtest_name = 'pspq_InformantReport_dad_on_mom_page3' WHERE Test_name = 'pspq_InformantReport_dad_on_mom' AND Order_number = 3;