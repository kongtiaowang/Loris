CREATE TABLE `pspq_InformantReport_dad_on_mom` (
    ...
    `prs_score` varchar(255) default NULL,
    `rigid_score` varchar(255) default NULL,
    ...
    `qi4_hard_avoid_sidetrack` enum('1_very_rarely','2_rarely','3_occasionally','4_somewhat_often','5_often','6_very_often','na') default NULL,
    ...
    `qi25_connecting_people` enum('1_very_rarely','2_rarely','3_occasionally','4_somewhat_often','5_often','6_very_often','na') default NULL,
    ...
    `qi29_longpauses_conversations` enum('1_very_rarely','2_rarely','3_occasionally','4_somewhat_often','5_often','6_very_often','na') default NULL,
