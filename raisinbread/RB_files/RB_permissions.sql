...
INSERT INTO `permissions` (`permID`, `code`, `description`, `moduleID`, `action`, `categoryID`) VALUES (70,'schedule_module','Schedule Module: edit and delete appointment',44,'Create/Edit',2);
UNLOCK TABLES;
