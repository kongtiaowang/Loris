window["lorisjs"] = window["lorisjs"] || {}; window["lorisjs"]["portal"] = window["lorisjs"]["portal"] || {}; window["lorisjs"]["portal"]["CandidateInstrumentList"] =
...
/* harmony import */ var _VisitInstrumentList__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11);
/* eslint-disable */
...
function CandidateInstrumentList(props) {
  ...
  var visits = props.Visits.filter(function (visit) {
...
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12);
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(sweetalert2__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var html_entities__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(13);
...
/* harmony import */ var Modal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(17);
/* harmony import */ var _VisitCompleteForm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(18);
...
var VisitInstrumentList = /*#__PURE__*/function (_Component) {
  ...
  function VisitInstrumentList(props) {
    ...
    _this.getInstrument_Not_Completed_Reason_Options = _this.getInstrument_Not_Completed_Reason_Options.bind(_assertThisInitialized(_this));
    _this.calcAge = _this.calcAge.bind(_assertThisInitialized(_this));
    _this.getVisitStatus = _this.getVisitStatus.bind(_assertThisInitialized(_this)); //NewCode

    _this.showModal = _this.showModal.bind(_assertThisInitialized(_this));
    _this.hideModal = _this.hideModal.bind(_assertThisInitialized(_this)); // End
  ...
  _createClass(VisitInstrumentList, [{
    ...
    key: "getInstrument_Not_Completed_Reason_Options",
    value: function getInstrument_Not_Completed_Reason_Options() {
      var _this4 = this;

      console.log('get Instrument_Not_Completed_Reason options');
      fetch(this.props.BaseURL + '/portal/portal_util?data=get_instrument_incomplete_reasons_option').then(function (response) {
        return response.json();
      }).then(function (json) {
        //console.log(json.instrument_incomplete_reasons_option);
        _this4.setState({
          Instrument_Not_Completed_Reason_options: json.instrument_incomplete_reasons_option
        });
      });
    ...
    key: "getVisitStatus",
    value: function getVisitStatus() {
      var _this5 = this;

      console.log('get Visit Completion Status');
      fetch(this.props.BaseURL + '/portal/portal_util' + '?candID=' + this.props.Candidate.Meta.CandID + '&session=' + this.props.Visit.Meta.Visit + '&data=get_visit_status').then(function (response) {
        return response.json();
      }).then(function (json) {
        var visit_completed = json[0].Visit_completed;

        _this5.setState({
          VisitStatus: visit_completed
        }, function () {
          console.log(_this5.state.VisitStatus);
        });
      });
    }
    /**
    ...
    value: function render() {
      ...
      var inperson_visit_status = 'In Progress';
      var VisitStatus = this.state.VisitStatus;
      var visit_status = VisitStatus; // Check if count is greater than 5
      ...
      var modal = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Modal__WEBPACK_IMPORTED_MODULE_3__["default"], {
        show: this.state.show,
        onClose: function onClose() {
          return _this6.hideModal();
        }
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_VisitCompleteForm__WEBPACK_IMPORTED_MODULE_4__["default"], {
        onSaveForm: this.hideModal,
      ...
      var flexcontainer = (_flexcontainer = {
        display: 'flex',
        flexDirection: 'row',
        flexWrap: 'nowrap',
        width: '100%',
      ...
      }, _defineProperty(_flexcontainer, "alignItems", 'center'), _defineProperty(_flexcontainer, "zIndex", '11'), _flexcontainer);
      ...
      if (!this.state.instruments) {
        ...
        instruments = this.state.instruments.map(function (instrument) {
          ...
          var ScanQR = function ScanQR(testname, linkURI) {
            var onScan = function onScan(value) {
              try {
                var obj = JSON.parse(value);
                console.log(obj); // Check VL and PSCID match

                if (obj.PSCID !== _this6.props.Candidate.Meta.PSCID || obj.VisitLabel !== _this6.props.Visit.Meta.Visit) {
          ...
          if (instrument.NumOfConflict != 0) {
            conflicterror = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
              href: _this6.props.BaseURL + '/conflict_resolver/?candidateID=' + _this6.props.Candidate.Meta.CandID + '&instrument=' + instrument.Test_name + '&visitLabel=' + _this6.props.Visit.Meta.Visit
          ...
          var linkURI = Object(html_entities__WEBPACK_IMPORTED_MODULE_2__["decode"])(instrument.ExternalDataEntryURL) ? Object(html_entities__WEBPACK_IMPORTED_MODULE_2__["decode"])(instrument.ExternalDataEntryURL) : _this6.props.BaseURL + '/instruments/' + instrument.Test_name + '?commentID=' + instrument.CommentID + '&candID=' + _this6.props.Candidate.Meta.CandID + '&sessionID=' + _this6.props.Visit.Meta.Visit;
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
            ...
            href: linkURI
          }, instrument.Full_name)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("progress", {
            value: instrument.Completion,
            max: "100"
          }, instrument.Completion + '%')), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
            href: linkURI
          }, "link to access")));
        });
        ...
        if (this.state.instruments.length === 0) {
          ...
          }, "Action"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tbody", null, instruments)));
        }
      }
      ...
      if (this.props.VisitMap) {
        visitLink = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
        ...
        visitLink = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, this.props.Visit.Meta.Visit);
      }
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      ...
      }, visitLink)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("dl", {
        style: defliststyle
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        style: termstyle
        ...
        style: termstyle
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("dt", null, "In Person Visit Status"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("dd", null, inperson_visit_status))), instruments), VisitStatus == 'N' && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "mb",
        style: {
          zIndex: 1
        }
      }, modal, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        type: "button",
        onClick: this.showModal
      }, "Mark In Person Visit As Complete")), VisitStatus == 'Y' && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "mb",
        style: {
          zIndex: 1
        }
...
Object.defineProperty(exports, "__esModule", { value: true });
var named_references_1 = __webpack_require__(14);
var numeric_unicode_map_1 = __webpack_require__(15);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return VisitCompleteForm; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _FormTable__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(19);
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(12);
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(sweetalert2__WEBPACK_IMPORTED_MODULE_2__);
...
function VisitCompleteForm(props) {
  ...
  var _useState5 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(true),
      ...
      canSave = _useState6[0],
      setCanSave = _useState6[1];
  ...
  var options3 = props.Instrument_Not_Completed_Reason;
  var opt3 = {};

  for (var key in options3) {
    var value = options3[key];
    opt3[value] = value;
  }
  /**
   * On page load
  ...
  function fetchData() {
    setCanSave(true);
    var url = loris.BaseURL + '/portal/portal_util' + '?candID=' + props.candId + '&session=' + props.session + '&data=VisitCompletion';
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    if (formData !== undefined) {
      for (var i = 0; i < formData.length; i++) {
        ...
        var rowErrors = formErrors[i];
        var date = void 0,
            time = void 0;
        tmpRows.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
          key: rowData.CommentID
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
          className: "xs-col"
        }, i + 1), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null, rowData.Instrument), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
          className: "sm-col"
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(SelectElement, {
          name: "instr_row_".concat(i, "_instrument_").concat(rowData.CommentID, "_Administration"),
          options: options,
          ...
          name: "instr_row_".concat(i, "_instrument_").concat(rowData.CommentID, "_Data_entry"),
          options: options2,
          onUserInput: onUserInput,
          sortByValue: false,
          value: rowData.Administration == 'None' ? null : options2[rowData.Data_entry],
          disabled: options[rowData.Administration] == 'None',
          hasError: rowErrors.Data_entry != '',
          errorMessage: rowErrors.Data_entry
        })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", {
          className: "sm-col"
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(SelectElement, {
          name: "instr_row_".concat(i, "_instrument_").concat(rowData.CommentID, "_Administration_incomplete_reason"),
          options: opt3,
          onUserInput: onUserInput,
          sortByValue: false,
          value: rowData.Administration == 'All' ? null : opt3[rowData.Administration_incomplete_reason],
          disabled: options[rowData.Administration] == 'All',
          ...
          name: "instr_row_".concat(i, "_instrument_").concat(rowData.CommentID, "_Administration_incomplete_reason_other"),
          onUserInput: onUserInput,
          value: rowData.Administration_incomplete_reason != 'Other' || options[rowData.Administration] == 'All' ? null : rowData.Administration_incomplete_reason_other,
          disabled: opt3[rowData.Administration_incomplete_reason] != 'Other' || options[rowData.Administration] == 'All',
  ...
  function onUserInput(formElement, value) {
    setCanSave(true);
    var i = formElement.split('_')[2]; // let id = formElement.split('_')[3];

    var formDataCopy = _toConsumableArray(formData);

    var rowDataCopy = _objectSpread({}, formDataCopy[i]);
  ...
  function getFormErrors() {
    ...
    var formErrorsCopy = _toConsumableArray(formErrors);

    for (var i = 0; i < formData.length; i++) {
      var rowData = formData[i];
      var rowErrorsCopy = formErrorsCopy[i];

      if (!rowData.Administration) {
        rowErrorsCopy['Administration'] = 'Required.';
        errorMessagesArr.push("Administration is Required at Row ".concat(i + 1));
        ...
        errorMessagesArr.push("Data Entry Should be Complete for Administration set to All at Row ".concat(i + 1));
        ...
        errorMessagesArr.push("Instrument Incomplete Reason is Required at Row ".concat(i + 1));
        ...
        errorMessagesArr.push("Instrument Incomplete Other Reason is Required at Row ".concat(i + 1));
      }
  ...
  function trySaveForm() {
    resetErrors();
    var swalErrorArr = getFormErrors();

    if (swalErrorArr.length > 0) {
      var swalErrorStr = swalErrorArr.join('<br>');
      sweetalert2__WEBPACK_IMPORTED_MODULE_2___default.a.fire({
      ...
      for (var i = 0; i < formData.length; i++) {
        var rowData = formData[i]; // Required Fields

        tmp.push("".concat(rowData.CommentID, "_Administration=").concat(rowData.Administration));

        if (rowData.Administration == 'All') {
          tmp.push("".concat(rowData.CommentID, "_Data_entry=").concat(rowData.Data_entry));
        }

        if (rowData.Administration != 'All') {
          tmp.push("".concat(rowData.CommentID, "_Administration_incomplete_reason=").concat(rowData.Administration_incomplete_reason));
        }

        if (rowData.Administration_incomplete_reason == 'Other') {
          tmp.push("".concat(rowData.CommentID, "_Administration_incomplete_reason_other=").concat(rowData.Administration_incomplete_reason_other));
        }
      }

      var putUrl = loris.BaseURL + '/portal/visit_complete';
      var body = ['candID=' + props.candId, 'session=' + props.session, 'update=UpdateVisitComplete'];
      body = body.concat(tmp).join('&');
      fetch(loris.BaseURL + '/portal/visit_complete', {
        method: 'POST',
        cache: 'no-cache',
        ...
        if (response.status != 200) {
          sweetalert2__WEBPACK_IMPORTED_MODULE_2___default.a.fire("".concat(response.status, " ").concat(response.statusText), 'The Form Was Not Saved.', 'error');
        } else {
          sweetalert2__WEBPACK_IMPORTED_MODULE_2___default.a.fire({
            title: 'Success!',
  ...
  function callBack() {
    console.log('callBack'); //trySaveForm();
  }
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "VisitCompleteForm",
    style: styles
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(FormElement, {
    className: "FormElement",
    name: "form",
    fileUpload: false,
    onUserInput: onUserInput,
    onSubmit: callBack
  }, rows === [] ? null : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_FormTable__WEBPACK_IMPORTED_MODULE_1__["default"], {
    name: "visitCompleteForm",
    columns: columns,
    rows: rows
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("label", null, "Please confirm you have checked both your email, and the LORIS Issue Tracker for any CRF's for this visit "), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("label", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
    type: "checkbox",
    checked: isChecked,
    onChange: handleCheckboxChange
  }), "Yes, I confirm I have checked"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return FormTable; });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* eslint-disable */
...
function FormTable(props) {
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "FormTable",
    id: props.name
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("table", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("thead", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", null, props.columns.map(function (col) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("th", {
      key: col.id
    }, col.label);
  }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tbody", null, props.rows)));
}
