window["lorisjs"] = window["lorisjs"] || {}; window["lorisjs"]["portal"] = window["lorisjs"]["portal"] || {}; window["lorisjs"]["portal"]["index"] =
...
/* harmony import */ var _jsx_CSSGrid__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(21);
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(12);
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(sweetalert2__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var regenerator_runtime_runtime__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(24);
...
function IndexPage(props) {
  var _useState = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(null),
      ...
      CandID = _useState2[0],
      setCandID = _useState2[1];

  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(null),
      _useState4 = _slicedToArray(_useState3, 2),
      VisitLabel = _useState4[0],
      setVisitLabel = _useState4[1];
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    var candID = urlParams.get('CandID');
    var visitLabel = urlParams.get('VisitLabel');
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    var loadCandidate = /*#__PURE__*/function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return fetch("".concat(props.BaseURL, "/api/v0.0.3/candidates/").concat(CandID));
      ...
      return function loadCandidate() {
        return _ref.apply(this, arguments);
      };
    }();

    var loadVisits = /*#__PURE__*/function () {
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.prev = 0;
                visits = candidate.Visits.map( /*#__PURE__*/function () {
                  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(visit) {
                    var response, data;
                    return regeneratorRuntime.wrap(function _callee2$(_context2) {
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          case 0:
                            _context2.next = 2;
                            return fetch("".concat(props.BaseURL, "/api/v0.0.3/candidates/").concat(candidate.Meta.CandID, "/").concat(visit));
                ...
                return _context3.abrupt("return", Promise.all(visits));
      ...
      return function loadVisits(_x) {
        return _ref2.apply(this, arguments);
      };
    }();

    loadCandidate().then(function (candidate) {
      return loadVisits(candidate);
  ...
  if (CandID === null || VisitLabel === null) {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h1", null, "Missing CandID or VisitLabel"));
  }

  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_jsx_CSSGrid__WEBPACK_IMPORTED_MODULE_1__["default"], {
    Cards: cards
  });
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var jsx_Card__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(22);
...
function CSSGrid(props) {
  var cardsRef = Object(react__WEBPACK_IMPORTED_MODULE_1__["useRef"])(null);
  ...
  var _useState3 = Object(react__WEBPACK_IMPORTED_MODULE_1__["useState"])({}),
      _useState4 = _slicedToArray(_useState3, 2),
      panelHeights = _useState4[0],
      setPanelHeights = _useState4[1];
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    ...
    var wSize = cardsRef.current.childNodes[0].clientWidth; // Do not change the state unless the width changed to avoid
    ...
    setCardWidth(wSize); // Store the height in pixels of each panel. The first node is
    ...
    var heights = Array.from(cardsRef.current.childNodes.values()).map(function (node) {
      return node.firstChild.clientHeight;
    });
  ...
  var lastLargeCardIdx = 0;

  for (var _i2 = 0; _i2 < orderedCards.length; _i2++) {
    if (orderedCards[_i2].Width >= 2) {
      lastLargeCardIdx = _i2;
    }
  }

  var cards = orderedCards.map(function (value, idx) {
    var cardID = 'card' + idx;
    var pSize;
    var style = {};
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(jsx_Card__WEBPACK_IMPORTED_MODULE_0__["default"], {
      title: value.Title,
      id: cardID,
      key: cardID,
      style: style,
      cardSize: pSize,
      collapsing: value.collapsing
    }, value.Content);
  });
...
/* harmony import */ var jsx_Panel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(23);
...
var Card = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Card, [{
    ...
    value: function render() {
      var cursorStyle = this.props.onClick ? {
        cursor: 'pointer'
      } : null;
      var divStyling = {
        marginLeft: '5px',
      ...
      if (this.props.style) {
        divStyling = _objectSpread(_objectSpread({}, divStyling), this.props.style);
      }
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        style: divStyling
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(jsx_Panel__WEBPACK_IMPORTED_MODULE_2__["default"], {
        id: this.props.id,
...
Card.propTypes = {
  ...
  initCollapsed: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.bool
};
Card.defaultProps = {
  onClick: null,
  initCollapsed: false
