window["lorisjs"] = window["lorisjs"] || {}; window["lorisjs"]["portal"] = window["lorisjs"]["portal"] || {}; window["lorisjs"]["portal"]["CandidateInfo"] =
...
var CandidateInfo = /*#__PURE__*/function (_Component) {
  ...
  function CandidateInfo(props) {
    ...
    _this.getSubprojects = _this.getSubprojects.bind(_assertThisInitialized(_this));
    _this.getVisitList = _this.getVisitList.bind(_assertThisInitialized(_this));
    return _this;
  }
  /**
  ...
  _createClass(CandidateInfo, [{
    ...
    value: function calcAge(dob) {
      ...
      var months = years * 12 + now.getMonth() - dobdate.getMonth();
    ...
    key: "getSubprojects",
    value: function getSubprojects(visits) {
      var mapped = _toConsumableArray(new Set(visits.map(function (visit) {
    ...
    key: "getVisitList",
    value: function getVisitList(visits) {
      var visitlinks = visits.map(function (visit) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
          key: visit.Meta.Visit
        }, visit.Meta.Visit);
      });
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, // Equivalent of .join(', ') that doesn't convert the React
      ...
      visitlinks.reduce(function (acc, el) {
        if (acc === null) {
          return [el];
        }
    ...
    value: function render() {
      var subprojects = this.getSubprojects(this.props.Visits);
      var subprojlabel = subprojects.length == 1 ? 'Subproject' : 'Subprojects';
      var data = [{
        label: 'PSCID',
      ...
      */
      ...
      var renderTerm = function renderTerm(label, value, info) {
        var cardStyle = {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          style: cardStyle,
          key: label
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("dt", null, label), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("dd", {
          style: valueStyle
        }, value));
      };

      var cardInfo = data.map(function (info) {
        return renderTerm(info.label, info.value, info);
      });
      var extrainfo;
      ...
      if (this.props.ExtraCandidateInfo.length > 0) {
        ...
        // side of caution.
        extrainfo = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("hr", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("dl", {
          style: {
            display: 'flex',
            flexFlow: 'wrap',
            margin: 0
          }
        }, this.props.ExtraCandidateInfo.map(function (obj) {
          return renderTerm(obj.term, obj.value, {
            width: '12em'
          });
        })));
      }
...
CandidateInfo.propTypes = {
  ...
  Candidate: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.object.isRequired,
  Visits: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.array.isRequired
};
