window["lorisjs"] = window["lorisjs"] || {}; window["lorisjs"]["survey_accounts"] = window["lorisjs"]["survey_accounts"] || {}; window["lorisjs"]["survey_accounts"]["surveyAccountsIndex"] =
...
var SurveyAccountsIndex = /*#__PURE__*/function (_Component) {
  _inherits(SurveyAccountsIndex, _Component);

  var _super = _createSuper(SurveyAccountsIndex);

  function SurveyAccountsIndex(props) {
    var _this;

    _classCallCheck(this, SurveyAccountsIndex);
  ...
  _createClass(SurveyAccountsIndex, [{
    ...
    value: function formatColumn(column, cell, row) {
      ...
      switch (column) {
        ...
        case 'Instrument':
          result = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null, this.state.data.fieldOptions.instruments[cell]);
          break;

        case 'Parent Portal':
          if (cell !== 'NA') {
            var portalUrl = loris.BaseURL + '/parent_portal/?id=' + row['Parent Portal'];
            result = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
              href: portalUrl,
              target: "_blank"
            }, "Go To Parent Portal"));
    ...
    value: function render() {
      ...
      var addSurvey = function addSurvey() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(FilterableDataTable__WEBPACK_IMPORTED_MODULE_3__["default"], {
        name: "surveyAccounts",
...
window.addEventListener('load', function () {
  ReactDOM.render( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(SurveyAccountsIndex, {
    dataURL: "".concat(loris.BaseURL, "/survey_accounts/?format=json")
...
/***/ })
/******/ ]);
//# sourceMappingURL=surveyAccountsIndex.js.map