window["lorisjs"] = window["lorisjs"] || {}; window["lorisjs"]["dqt_clean"] = window["lorisjs"]["dqt_clean"] || {}; window["lorisjs"]["dqt_clean"]["react.app"] =
...
/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(19);
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(28);
...
/* harmony import */ var _react_navigationStepper__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(30);
/* harmony import */ var _components_stepper__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(17);
/* harmony import */ var _react_savedqueries__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(31);
/* harmony import */ var _components_expansionpanels__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(0);
/* harmony import */ var _react_notice__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(32);
/* harmony import */ var _components_datarequest__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(33);
...
var DataQueryApp = /*#__PURE__*/function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_4___default()(DataQueryApp, [{
      ...
      for (var key in this.state.queryIDs) {
        if (this.state.queryIDs.hasOwnProperty(key)) {
          for (var i = 0; i < this.state.queryIDs[key].length; i += 1) {
            ...
            curRequest = Promise.resolve($.ajax(loris.BaseURL + '/AjaxHelper.php?Module=dqt_clean&script=GetDoc.php&DocID=' + encodeURIComponent(this.state.queryIDs[key][i])), {
              data: {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return fetch("".concat(loris.BaseURL, "/dqt_clean/dqt_setup/?format=json"), {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_9___default.a.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return fetch("".concat(loris.BaseURL, "/dqt_clean/sessions/?format=json"), {
                  credentials: 'same-origin',
                  method: 'GET'
                });
    ...
    value: function saveCurrentQuery(name, shared, override) {
      ...
      $.post(loris.BaseURL + '/AjaxHelper.php?Module=dqt_clean&script=saveQuery.php', {
        ...
        $.get(loris.BaseURL + '/AjaxHelper.php?Module=dqt_clean&script=GetDoc.php&DocID=' + id, function (value) {
    ...
    value: function loadFilterRule(rule) {
      ...
      $.ajax({
        url: loris.BaseURL + '/AjaxHelper.php?Module=dqt_clean&script=datadictionary.php',
      ...
      $.ajax({
        url: loris.BaseURL + '/AjaxHelper.php?Module=dqt_clean&script=' + script,
        success: function success(data) {
          var i;
          var allSessions = {};
    ...
    value: function loadSavedQuery(fields, criteria) {
      ...
      for (var _i2 = 0; _i2 < fieldsList.length; _i2++) {
        $.ajax({
          url: loris.BaseURL + '/dqt_clean/ajax/datadictionary.php',
          success: function success(data) {
    ...
    value: function fieldChange(fieldName, category, downloadable) {
      ...
      this.setState(function (state) {
        ...
        if (!selectedFields[category]) {
          ...
          selectedFields[category][fieldName] = JSON.parse(JSON.stringify(_this8.state.Visits)); // Add all visits to the given category, initializing their counts to 1
    ...
    value: function runQuery(fields) {
      ...
      for (var i = 0; i < fields.length; i += 1) {
        ...
        if (DocTypes.indexOf(category) === -1) {
          ...
          $.ajax({
            type: 'POST',
            url: loris.BaseURL + '/AjaxHelper.php?Module=dqt_clean&script=' + 'retrieveCategoryDocs.php',
            data: {
              DocType: category,
      ...
      tabs.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement(_components_stepper__WEBPACK_IMPORTED_MODULE_13__["StepperPanel"], {
        ...
        content: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_10___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement("h1", {
          ...
          panels: [{
            ...
            }, "\"Run Query\""), " and run the query you built. \uD83D\uDE42"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement("p", {
              style: {
                textAlign: 'center'
              }
            }, "Please read the\xA0", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement("a", {
              style: {
                textDecoration: 'underline'
              },
              href: 'https://docs.google.com/document/d/' + '1E8BC9guVrXUd2KDKlX9pu0xch5Ex56lgKw34cEchaek',
              target: "_blank"
            }, "\"Manual Of Operations\""), "\xA0document for additional information.")),
            alwaysOpen: false
          }, {
        ...
        }, "Controlled Data Request"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_10___default.a.createElement(_components_datarequest__WEBPACK_IMPORTED_MODULE_17__["default"], {
...
DataQueryApp.propTypes = {
  ...
  AllSessions: prop_types__WEBPACK_IMPORTED_MODULE_11___default.a.array,
...
/* harmony import */ var _components_stepper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(17);
