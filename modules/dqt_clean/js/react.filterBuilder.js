window["lorisjs"] = window["lorisjs"] || {}; window["lorisjs"]["dqt_clean"] = window["lorisjs"]["dqt_clean"] || {}; window["lorisjs"]["dqt_clean"]["react.filterBuilder"] =
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(FilterRule, [{
    ...
    value: function selectInstrument(event) {
      ...
      if (event.target.value) {
        ...
        $.get(loris.BaseURL + '/dqt_clean/ajax/datadictionary.php', {
    ...
    value: function valueSet() {
      ...
      if (this.state.value) {
        ...
        var ajaxRetrieve = function ajaxRetrieve(script) {
          $.get(loris.BaseURL + '/dqt_clean/ajax/' + script, {
            category: rule.instrument,
            field: rule.field,
...
var FilterBuilder = /*#__PURE__*/function (_Component4) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(FilterBuilder, [{
    ...
    value: function render() {
      ...
      }, "The Query's Filter")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("div", {
        className: "row"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("div", {
        className: "col-xs-12"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("div", {
