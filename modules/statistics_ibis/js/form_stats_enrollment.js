...
function updateEnrollmentTab() {       
    ...
    var request = $.ajax({
        url: loris.BaseURL + '/statistics_ibis/stats_enrollment/?dynamictabs=dynamictabs&EnrollmentProject=' + EnrollmentProject.value + '&EnrollmentSite=' + EnrollmentSite.value,
        type: 'GET',
        data: 'html',
