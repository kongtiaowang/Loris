  ...
  formatColumn(column, cell, row) {
    ...
    switch (column) {
      case 'File Name':
        ...
        // IBIS uses file id to fix issue with duplicate file names
        let downloadURL = loris.BaseURL + '/document_repository/Files/' + row['Edit'] + '/' + encodeURIComponent(row['File Name']);
