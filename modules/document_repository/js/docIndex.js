window["lorisjs"] = window["lorisjs"] || {}; window["lorisjs"]["document_repository"] = window["lorisjs"]["document_repository"] || {}; window["lorisjs"]["document_repository"]["docIndex"] =
...
/* harmony import */ var Tabs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _uploadForm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10);
/* harmony import */ var _categoryForm__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(13);
/* harmony import */ var _parentTree__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(14);
/* harmony import */ var _childTree__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(15);
/* harmony import */ var Loader__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(12);
/* harmony import */ var FilterableDataTable__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(16);
/* harmony import */ var _NullFilterableDataTable__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(25);
...
var DocIndex = /*#__PURE__*/function (_React$Component) {
  _inherits(DocIndex, _React$Component);

  var _super = _createSuper(DocIndex);

  function DocIndex(props) {
    var _this;

    _classCallCheck(this, DocIndex);
    ...
    _this.handleGlobal = _this.handleGlobal.bind(_assertThisInitialized(_this));
    ...
    _this.newCategoryState = _this.newCategoryState.bind(_assertThisInitialized(_this));
    _this.getAllData = _this.getAllData.bind(_assertThisInitialized(_this));
    _this.dataByNode = _this.dataByNode.bind(_assertThisInitialized(_this));
    _this.getContent = _this.getContent.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(DocIndex, [{
    ...
    key: "handleGlobal",
    value: function handleGlobal(formElement, value) {
    ...
    value: function getAllData() {
      ...
      return fetch(loris.BaseURL + '/document_repository/docTree/0').then(function (response) {
        ...
        var filterData = _this3.state.data.Data;
        var fillData = filterData.filter(function (data) {
    ...
    key: "dataByNode",
    value: function dataByNode(id) {
      var _this4 = this;

      return fetch(loris.BaseURL + '/document_repository/docTree/' + id).then(function (response) {
        return response.json();
      }).then(function (myJson) {
        var allNodesArray = [];
        var nodesArray = [];
        ...
        var filterData = _this4.state.data.Data;
        var fillData = filterData.filter(function (data) {
          return Object.values(nodesArray).includes(data[10]);
        });
    ...
    value: function newCategoryState() {
      this.setState({
        newCategory: true
      });
    }
    ...
    value: function formatColumn(column, cell, row) {
      var result = /*#__PURE__*/React.createElement("td", null, cell);

      switch (column) {
        case 'File Name':
          // IBIS SPECIFIC OVERRIDE CODE
          // IBIS uses file id to fix issue with duplicate file names
          var downloadURL = loris.BaseURL + '/document_repository/Files/' + row['Edit'] + '/' + encodeURIComponent(row['File Name']); // IBIS SPECIFIC OVERRIDE CODE ENDS HERE

          result = /*#__PURE__*/React.createElement("td", null, /*#__PURE__*/React.createElement("a", {
            href: downloadURL,
            target: "_blank",
        ...
        case 'Edit':
          var editURL = loris.BaseURL + '/document_repository/edit/' + row['Edit'];
          result = /*#__PURE__*/React.createElement("td", null, /*#__PURE__*/React.createElement("a", {
            href: editURL
          }, "Edit"));
          break;
        ...
        case 'Delete File':
          ...
          var click = function click() {
            swal({
              ...
              var deleteurl = loris.BaseURL + '/document_repository/Files/' + id;
              fetch(deleteurl, {
                method: 'DELETE',
                cache: 'no-cache',
                credentials: 'same-origin'
    ...
    value: function render() {
      ...
      if (!this.state.isLoaded) {
        return /*#__PURE__*/React.createElement(Loader__WEBPACK_IMPORTED_MODULE_5__["default"], null);
      }
      ...
      var fields = [{
        ...
        label: 'Delete File',
        show: this.props.hasPermission('superUser') || this.props.hasPermission('document_repository_delete')
      }, {
        label: 'File Category',
        show: false
      }, {
      ...
      if (loris.userHasPermission('document_repository_view')) {
        ...
        uploadDoc = /*#__PURE__*/React.createElement(Tabs__WEBPACK_IMPORTED_MODULE_0__["TabPane"], {
          TabId: tabList[1].id
        }, /*#__PURE__*/React.createElement(_uploadForm__WEBPACK_IMPORTED_MODULE_1__["default"], {
          dataURL: "".concat(loris.BaseURL, "/document_repository/?format=json"),
          action: "".concat(loris.BaseURL, "/document_repository/Files"),
          maxUploadSize: this.state.data.maxUploadSize,
          refreshPage: this.fetchData,
          category: this.state.newCategory
        }));
        uploadCategory = /*#__PURE__*/React.createElement(Tabs__WEBPACK_IMPORTED_MODULE_0__["TabPane"], {
          TabId: tabList[2].id
        }, /*#__PURE__*/React.createElement(_categoryForm__WEBPACK_IMPORTED_MODULE_2__["default"], {
          dataURL: "".concat(loris.BaseURL, "/document_repository/?format=json"),
          action: "".concat(loris.BaseURL, "/document_repository/UploadCategory"),
          refreshPage: this.fetchData,
          newCategoryState: this.newCategoryState
        }));
      }

      var parentTree = this.state.global ? null : /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(_parentTree__WEBPACK_IMPORTED_MODULE_3__["default"], {
        action: this.getContent,
        parentNode: this.state.parentNode
      }));
      var treeTable = Object.keys(this.state.tableData.length).length === 0 && Object.keys(this.state.childrenNode).length === 0 ? /*#__PURE__*/React.createElement(_NullFilterableDataTable__WEBPACK_IMPORTED_MODULE_7__["default"], null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(CheckboxElement, {
      ...
      }), /*#__PURE__*/React.createElement(FilterableDataTable__WEBPACK_IMPORTED_MODULE_6__["default"], {
        name: "document",
        data: this.state.tableData,
        fields: fields,
        getFormattedCell: this.formatColumn,
        folder: /*#__PURE__*/React.createElement(_childTree__WEBPACK_IMPORTED_MODULE_4__["default"], {
          action: this.getContent,
          childrenNode: this.state.childrenNode
        })
      }, parentTree))) : /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(CheckboxElement, {
        name: "globalSelection",
        label: "Filter globally",
        id: "globalSelection",
        value: this.state.global,
      ...
      return /*#__PURE__*/React.createElement(Tabs__WEBPACK_IMPORTED_MODULE_0__["Tabs"], {
        tabs: tabList,
        defaultTab: "browse",
        updateURL: true
      }, /*#__PURE__*/React.createElement(Tabs__WEBPACK_IMPORTED_MODULE_0__["TabPane"], {
        TabId: tabList[0].id
      }, treeTable), uploadDoc, uploadCategory);
    }
  }]);
...
window.addEventListener('load', function () {
  ...
  }, /*#__PURE__*/React.createElement(DocIndex, {
    dataURL: "".concat(loris.BaseURL, "/document_repository/?format=json"),
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(sweetalert2__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var Loader__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(12);
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var DocUploadForm = /*#__PURE__*/function (_Component) {
  _inherits(DocUploadForm, _Component);

  var _super = _createSuper(DocUploadForm);

  function DocUploadForm(props) {
    var _this;

    _classCallCheck(this, DocUploadForm);
  ...
  _createClass(DocUploadForm, [{
    ...
    value: function render() {
      ...
      if (!this.state.isLoaded) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Loader__WEBPACK_IMPORTED_MODULE_3__["default"], null);
      }
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        method: "POST"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "Upload a file"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(SelectElement, {
        name: "category",
        label: "Category",
    ...
    value: function uploadFile() {
      ...
      fetch(this.props.action, {
        ...
        if (data == 'uploaded successfully') {
          sweetalert2__WEBPACK_IMPORTED_MODULE_2___default.a.fire('Upload Successful!', '', 'success').then(function (result) {
            if (result.value) {
              _this4.setState({
                formData: {}
              });

              _this4.props.refreshPage();
            }
          });
        } else {
          sweetalert2__WEBPACK_IMPORTED_MODULE_2___default.a.fire('Duplicate File Name!', '', 'error');
        }
      })["catch"](function (error) {
        console.error(error);
      });
...
/* harmony default export */ __webpack_exports__["default"] = (DocUploadForm);
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var Loader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12);
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(sweetalert2__WEBPACK_IMPORTED_MODULE_2__);
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var DocCategoryForm = /*#__PURE__*/function (_React$Component) {
  _inherits(DocCategoryForm, _React$Component);

  var _super = _createSuper(DocCategoryForm);

  function DocCategoryForm(props) {
    var _this;

    _classCallCheck(this, DocCategoryForm);
  ...
  _createClass(DocCategoryForm, [{
    ...
    value: function render() {
      ...
      if (!this.state.isLoaded) {
        return /*#__PURE__*/React.createElement(Loader__WEBPACK_IMPORTED_MODULE_1__["default"], null);
      }
      ...
      }, /*#__PURE__*/React.createElement("h3", null, "Add a category"), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement(TextboxElement, {
        name: "categoryName",
        label: "Category Name",
        onUserInput: this.setFormData,
        required: true,
    ...
    value: function uploadFile() {
      ...
      fetch(this.props.action, {
        ...
        if (resp.ok) {
          _this3.props.refreshPage();

          _this3.fetchData(); // refresh the upload page


          _this3.props.newCategoryState();
          ...
          sweetalert2__WEBPACK_IMPORTED_MODULE_2___default.a.fire('Category Successfully Added!', '', 'success');
        } else {
          resp.json().then(function (data) {
            sweetalert2__WEBPACK_IMPORTED_MODULE_2___default.a.fire('Could not add category!', data.error, 'error');
          })["catch"](function (error) {
            console.error(error);
            sweetalert2__WEBPACK_IMPORTED_MODULE_2___default.a.fire('Unknown Error!', 'Please report the issue or contact your administrator.', 'error');
          });
        }
      });
    }
  ...
  return DocCategoryForm;
}(React.Component);

DocCategoryForm.propTypes = {
  dataURL: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.string.isRequired,
  action: prop_types__WEBPACK_IMPORTED_MODULE_0___default.a.string.isRequired
};
/* harmony default export */ __webpack_exports__["default"] = (DocCategoryForm);
...
var ParentTree = /*#__PURE__*/function (_Component) {
  _inherits(ParentTree, _Component);

  var _super = _createSuper(ParentTree);

  function ParentTree(props) {
    var _this;

    _classCallCheck(this, ParentTree);
  ...
  _createClass(ParentTree, [{
    ...
    value: function render() {
      ...
      parentNode.unshift(['0', 'Root']); // let parentList = null;

      var parentList = parentNode.map(function (node, index) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
          key: index,
          style: divStyle,
          onClick: function onClick() {
            return _this2.action(Object.values(node));
          },
          className: "pointer"
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, parentList);
    }
  }]);
...
ParentTree.propTypes = {
  ...
  parentNode: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.array.isRequired
};
/* harmony default export */ __webpack_exports__["default"] = (ParentTree);
...
var ChildTree = /*#__PURE__*/function (_Component) {
  _inherits(ChildTree, _Component);

  var _super = _createSuper(ChildTree);

  function ChildTree(props) {
    var _this;

    _classCallCheck(this, ChildTree);
  ...
  _createClass(ChildTree, [{
    ...
    value: function render() {
      ...
      var childList = null;
      var childrenNode = this.props.childrenNode;

      if (Object.entries(childrenNode).length !== 0) {
        childList = childrenNode.map(function (node, index) {
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("tr", {
            ...
            style: spanStyle,
            className: "tool"
          }, Object.values(node)[1]), Object.values(node)[2] !== null && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
            style: commentStyle,
            className: "tip"
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("thead", null, childList);
    }
  }]);
...
ChildTree.propTypes = {
  action: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.func.isRequired,
  childrenNode: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.array.isRequired
};
/* harmony default export */ __webpack_exports__["default"] = (ChildTree);
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var jsx_Panel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(17);
/* harmony import */ var jsx_Tabs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(1);
...
var NullFilterableDataTable = /*#__PURE__*/function (_Component) {
  _inherits(NullFilterableDataTable, _Component);

  var _super = _createSuper(NullFilterableDataTable);

  function NullFilterableDataTable(props) {
    _classCallCheck(this, NullFilterableDataTable);

    return _super.call(this, props);
  }

  _createClass(NullFilterableDataTable, [{
    key: "render",
    value: function render() {
  ...
  return NullFilterableDataTable;
}(react__WEBPACK_IMPORTED_MODULE_0__["Component"]);

/* harmony default export */ __webpack_exports__["default"] = (NullFilterableDataTable);
