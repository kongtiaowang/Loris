...
var ProgressBar = /*#__PURE__*/function (_Component) {
  (0,_babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2__["default"])(ProgressBar, _Component);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ UploadForm)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ "./node_modules/@babel/runtime/helpers/esm/defineProperty.js");
/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/slicedToArray */ "./node_modules/@babel/runtime/helpers/esm/slicedToArray.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react */ "react");
...
/* harmony import */ var ProgressBar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ProgressBar */ "./jsx/ProgressBar.js");
...
function UploadForm(props) {
  ...
  var onFormChange = function onFormChange(field, value) {
    if (!field) return;

    var newFormData = _objectSpread(_objectSpread({}, formData), {}, (0,_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, field, value));

    if (field === 'eegFile' && value.name) {
      var patientName = value.name.replace(/\.[a-z]+\.?[a-z]+?$/i, '');
  ...
  var submitForm = function submitForm() {
    ...
    var fileName = data.eegFile.name; // Make sure file is of type .tar.gz format

    var properExt = new RegExp('\.(tar.gz)$');
    var pNameElements = [data.pscid, data.candID, data.visit, 'bids'];
    var fileNameConvention = pNameElements.join('_') + '.tar.gz';
    ...
    if (fileName !== fileNameConvention) {
      sweetalert2__WEBPACK_IMPORTED_MODULE_4___default().fire({
        ...
        text: 'Filename should be of the form ' + '[PSCID]_[CandID]_[VisitLabel]_bids.tar.gz',
        type: 'error',
        confirmButtonText: 'OK'
      });
      setErrorMessage({
  ...
  var processError = function processError(xhr) {
    ...
    if (xhr.response) {
      ...
      error = 'Please make sure files are not larger than ' + props.maxUploadSize;
    } else {
      error = 'Upload failed: received HTTP response code ' + xhr.status;
    }
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", {
    ...
    className: "col-md-7"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement("h3", null, "Upload an electrophysiology recording session"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(FormElement, {
    name: "upload_form",
    fileUpload: true
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(FileElement, {
    name: "eegFile",
  ...
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(TextboxElement, {
    name: "candID",
    label: "CandID",
    disabled: true,
    required: false,
  ...
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(StaticElement, {
    label: "Notes",
    text: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement("span", null, props.maxUploadSize && "File cannot exceed ".concat(props.maxUploadSize, "<br/>x"), "File name must match the following convention:", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement("b", null, "[PSCID]_[CandID]_[Visit Label]_bids.tar.gz"))
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", {
    className: "row"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement("div", {
    className: "col-sm-9 col-sm-offset-3"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(ProgressBar__WEBPACK_IMPORTED_MODULE_3__["default"], {
    value: uploadProgress
  }))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2___default().createElement(ButtonElement, {
    onUserInput: submitForm,
    buttonClass: 'btn btn-primary' + (uploadProgress > -1 ? ' hide' : '')
  }))));
}
UploadForm.propTypes = {
  autoLaunch: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string),
  uploadURL: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().string.isRequired),
  maxUploadSize: (prop_types__WEBPACK_IMPORTED_MODULE_5___default().number)
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ElectrophysiologyUploader)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/slicedToArray */ "./node_modules/@babel/runtime/helpers/esm/slicedToArray.js");
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! prop-types */ "./node_modules/prop-types/index.js");
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var jsx_Loader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! jsx/Loader */ "./jsx/Loader.js");
/* harmony import */ var jsx_Tabs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! jsx/Tabs */ "./jsx/Tabs.js");
/* harmony import */ var _UploadForm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./UploadForm */ "./modules/electrophysiology_uploader/jsx/UploadForm.js");
/* harmony import */ var _UploadViewer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./UploadViewer */ "./modules/electrophysiology_uploader/jsx/UploadViewer.js");
...
function ElectrophysiologyUploader(props) {
  ...
  var fetchData = function fetchData() {
    fetch("".concat(props.DataURL, "/?format=json"), {
      method: 'GET'
  ...
  if (!isLoaded) {
    return /*#__PURE__*/React.createElement(jsx_Loader__WEBPACK_IMPORTED_MODULE_2__["default"], null);
  }
  ...
  return /*#__PURE__*/React.createElement(jsx_Tabs__WEBPACK_IMPORTED_MODULE_3__.Tabs, {
    tabs: tabList,
    defaultTab: "browse",
    updateURL: true
  }, /*#__PURE__*/React.createElement(jsx_Tabs__WEBPACK_IMPORTED_MODULE_3__.TabPane, {
    TabId: tabList[0].id
  }, /*#__PURE__*/React.createElement(_UploadViewer__WEBPACK_IMPORTED_MODULE_5__["default"], {
    data: data.Data,
    fieldOptions: data.fieldOptions
  })), /*#__PURE__*/React.createElement(jsx_Tabs__WEBPACK_IMPORTED_MODULE_3__.TabPane, {
    TabId: tabList[1].id
  }, /*#__PURE__*/React.createElement(_UploadForm__WEBPACK_IMPORTED_MODULE_4__["default"], {
    uploadURL: "".concat(props.DataURL, "/upload")
  })));
}
ElectrophysiologyUploader.propTypes = {
  DataURL: (prop_types__WEBPACK_IMPORTED_MODULE_7___default().string.isRequired)
};
/**
...
document.addEventListener('DOMContentLoaded', function () {
  (0,react_dom_client__WEBPACK_IMPORTED_MODULE_6__.createRoot)(document.getElementById('lorisworkspace')).render( /*#__PURE__*/React.createElement(ElectrophysiologyUploader, {
...
((window.lorisjs = window.lorisjs || {}).electrophysiology_uploader = window.lorisjs.electrophysiology_uploader || {}).ElectrophysiologyUploader = __webpack_exports__;
/******/ })()
;
//# sourceMappingURL=ElectrophysiologyUploader.js.map