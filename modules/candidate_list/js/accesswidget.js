...
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
...
function AccessWidget() {
  ...
  function fetchDataForm(type, value) {
    return fetch(loris.BaseURL + '/candidate_list/CandidateUtil/' + type + '/' + value, {
      ...
      if (type === 'DCCID') {//	  setPSCID(data['PSCID']);
      }

      if (type === 'PSCID') {//	  setDCCID(data['DCCID']);
      }

      console.log(data['visit_label']);
      setDropdownValue(data['visit_label']);
      setSessionIDS(data['session']); // this.setState({formData: {...this.state.formData, SessionFieldOptions: data['Session']}});
  ...
  var handleSubmit = function handleSubmit(event) {
    event.preventDefault(); //  console.log("fjdslkfjdlsajldfjlkfjlkafjlkjflds");
    ...
    console.log(error); // window.location.href =  loris.BaseURL+"/portal?CandID="+DCCID+"&VisitLabel="+Visit;
  };
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h4", {
  ...
  }, errorDiv, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    ...
    value: ""
  }, "--Please choose a Visit Label--"), Object.keys(dropdownValue).map(function (key) {
