window["lorisjs"] = window["lorisjs"] || {}; window["lorisjs"]["quality_control"] = window["lorisjs"]["quality_control"] || {}; window["lorisjs"]["quality_control"]["qualityControlIndex"] =
...
/* harmony import */ var Loader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
/* harmony import */ var Tabs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(10);
/* harmony import */ var FilterableDataTable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(11);
...
var QualityControlIndex = /*#__PURE__*/function (_Component) {
  _inherits(QualityControlIndex, _Component);

  var _super = _createSuper(QualityControlIndex);

  function QualityControlIndex(props) {
    var _this;

    _classCallCheck(this, QualityControlIndex);
  ...
  _createClass(QualityControlIndex, [{
    key: "formatColumn",
      ...
      switch (column) {
        case 'Scan Done in MRI PF':
          if (cell == 'Yes') {
            ...
            var mpfURL = loris.BaseURL + '/instruments/' + instrumentName + '/?commentID=' + row.CommentID + '&sessionID=' + row['Session ID'] + '&candID=' + row.DCCID;
        ...
        case 'Tarchive':
          if (cell == 'In DICOM') {
            ...
            result = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("td", null, "Missing");
          }
    ...
    value: function componentDidMount() {
      ...
      this.fetchData(this.props.ImgDataURL, 'ImgData').then(function () {
        return _this2.setState({
          isLoadedImg: true
        });
      });
      this.fetchData(this.props.BehavioralDataURL, 'BehavioralData').then(function () {
        return _this2.setState({
    ...
    key: "fetchData",
    value: function fetchData(url, state) {
      var _this3 = this;
      ...
      return fetch(url, {
        ...
        return _this3.setState(_defineProperty({}, state, data));
    ...
    value: function render() {
      if (!this.state.isLoadedBehavioral || !this.state.isLoadedImg) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Loader__WEBPACK_IMPORTED_MODULE_1__["default"], null);
      }
      ...
      if (Object.keys(this.state.ImgData).length > 0) {
        ...
        var ImgOptions = this.state.ImgData.fieldOptions;
        var BehavioralOptions = this.state.BehavioralData.fieldOptions;
        var ImgFields = [{
          label: 'PSCID',
          show: true,
          filter: {
        ...
        var tab0 = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Tabs__WEBPACK_IMPORTED_MODULE_2__["TabPane"], {
          TabId: tabList[0].id
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(FilterableDataTable__WEBPACK_IMPORTED_MODULE_3__["default"], {
          name: "quality_control_behavioural",
          data: this.state.BehavioralData.Data,
          fields: BehavioralFields,
          getFormattedCell: this.formatColumn
        }));
        var tab1 = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Tabs__WEBPACK_IMPORTED_MODULE_2__["TabPane"], {
          TabId: tabList[1].id
        }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(FilterableDataTable__WEBPACK_IMPORTED_MODULE_3__["default"], {
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Tabs__WEBPACK_IMPORTED_MODULE_2__["Tabs"], {
          id: "TabPanes",
          tabs: tabList,
        ...
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "An error occurred while loading the page."));
      }
    }
  }]);
...
QualityControlIndex.propTypes = {
  ImgDataURL: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.string.isRequired,
  BehavioralDataURL: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.string.isRequired,
  hasPermission: prop_types__WEBPACK_IMPORTED_MODULE_4___default.a.func.isRequired
};
window.addEventListener('load', function () {
  ReactDOM.render( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(QualityControlIndex, {
    ImgDataURL: "".concat(loris.BaseURL, "/quality_control/?format=json"),
    BehavioralDataURL: "".concat(loris.BaseURL, "/quality_control/quality_control_behavioral/?format=json"),
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var jsx_Panel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(12);
/* harmony import */ var jsx_Tabs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(10);
