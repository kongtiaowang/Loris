  ...
  _createClass(CategoryList, [{
    ...
    value: function render() {
      ...
      var items = [],
        ...
        return _this3.selectCategory(name);
      };
...
var FieldItem = /*#__PURE__*/function (_Component3) {
  ...
  function FieldItem(props) {
    ...
    _this4.state = {};
    _this4.visitSelect = _this4.visitSelect.bind(_assertThisInitialized(_this4));
    return _this4;
  }
    ...
    value: function render() {
      ...
      if (this.props.selected) {
        ...
        multiselect = Object.keys(this.props.Visits).map(function (visit) {
          ...
          if (_this5.props.selectedVisits[visit]) {
            checked = true;
          }
...
var FieldList = /*#__PURE__*/function (_Component4) {
  ...
  function FieldList(props) {
    ...
    _this6.state = {};
    _this6.onFieldClick = _this6.onFieldClick.bind(_assertThisInitialized(_this6));
    return _this6;
  }
  ...
  _createClass(FieldList, [{
    ...
    value: function render() {
      ...
      for (var _i = start; _i < filteredItems.length; _i += 1) {
        ...
        type = filteredItems[_i].value.Type || 'varchar(255)'; // Check if field is a file, if so set flag to true
      ...
      }, fields, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(PaginationLinks, {
...
var FieldSelector = /*#__PURE__*/function (_Component5) {
  ...
  function FieldSelector(props) {
    ...
    for (var _i2 = 0; _i2 < _this7.props.items.length; _i2++) {
      instruments[_this7.props.items[_i2].category] = _this7.props.items[_i2].category;
    }
    ...
    _this7.onFieldSelect = _this7.onFieldSelect.bind(_assertThisInitialized(_this7));
    _this7.onCategorySelect = _this7.onCategorySelect.bind(_assertThisInitialized(_this7));
    _this7.filterChange = _this7.filterChange.bind(_assertThisInitialized(_this7));
    _this7.addAll = _this7.addAll.bind(_assertThisInitialized(_this7));
    _this7.deleteAll = _this7.deleteAll.bind(_assertThisInitialized(_this7));
    _this7.modifyCategoryFieldVists = _this7.modifyCategoryFieldVists.bind(_assertThisInitialized(_this7));
    _this7.changePage = _this7.changePage.bind(_assertThisInitialized(_this7));
    return _this7;
  }
  ...
  _createClass(FieldSelector, [{
    ...
    value: function onCategorySelect(elementName, category) {
      ...
      if (this.state.categoryFields[category]) {} else {
        ...
        $.get(loris.BaseURL + "/AjaxHelper.php?Module=dataquery&script=datadictionary.php", {
          ...
          var cf = _this8.state.categoryFields;
          cf[category] = data;
    ...
    value: function deleteAll() {
      ...
      var i, index, fieldName, category, isFile;
    ...
    value: function render() {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      ...
      }, "Search within instrument:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
      ...
      }, "Instrument:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "col-sm-12 col-md-8"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(SearchableDropdown, {
        name: "fieldsDropdown",
        ...
        className: "col-sm-12 col-md-4"
      }, "Visits:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        className: "col-sm-12 col-md-8"
...
FieldSelector.propTypes = {
  selectedFields: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.array
};
