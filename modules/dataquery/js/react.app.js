...
var SavedQueriesList = /*#__PURE__*/function (_Component) {
  _inherits(SavedQueriesList, _Component);
  ...
  function SavedQueriesList(props) {
    ...
    _classCallCheck(this, SavedQueriesList);

    _this = _super.call(this, props);
    _this.state = {};
    _this.loadQuery = _this.loadQuery.bind(_assertThisInitialized(_this));
    return _this;
  }

  _createClass(SavedQueriesList, [{
    ...
    value: function render() {
      ...
      for (var i = 0; i < this.props.userQueries.length; i += 1) {
        ...
        userSaved.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
      ...
      for (var _i = 0; _i < this.props.globalQueries.length; _i += 1) {
        ...
        globalSaved.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
        ...
        role: "button",
        "aria-expanded": "false"
      }, "Load Saved Query ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "caret"
      ...
      }, "User Saved Queries"), userSaved, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
        role: "presentation",
        className: "dropdown-header"
      }, "Shared Saved Queries"), globalSaved)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
        role: "presentation",
        id: "presentationMSQ"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
...
SavedQueriesList.propTypes = {
  queryDetails: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.array,
...
var DataQueryApp = /*#__PURE__*/function (_Component2) {
  _inherits(DataQueryApp, _Component2);
  ...
  function DataQueryApp(props) {
    ...
    _this2.saveFilterRule = _this2.saveFilterRule.bind(_assertThisInitialized(_this2));
    _this2.saveFilterGroup = _this2.saveFilterGroup.bind(_assertThisInitialized(_this2));
    _this2.saveCurrentQuery = _this2.saveCurrentQuery.bind(_assertThisInitialized(_this2));
    _this2.overrideQuery = _this2.overrideQuery.bind(_assertThisInitialized(_this2));
    _this2.loadFilterRule = _this2.loadFilterRule.bind(_assertThisInitialized(_this2));
    _this2.loadFilterGroup = _this2.loadFilterGroup.bind(_assertThisInitialized(_this2));
    _this2.loadSavedQuery = _this2.loadSavedQuery.bind(_assertThisInitialized(_this2));
    _this2.fieldVisitSelect = _this2.fieldVisitSelect.bind(_assertThisInitialized(_this2));
    _this2.fieldChange = _this2.fieldChange.bind(_assertThisInitialized(_this2));
    _this2.getSessions = _this2.getSessions.bind(_assertThisInitialized(_this2));
    _this2.runQuery = _this2.runQuery.bind(_assertThisInitialized(_this2));
    _this2.getRowData = _this2.getRowData.bind(_assertThisInitialized(_this2));
    _this2.dismissAlert = _this2.dismissAlert.bind(_assertThisInitialized(_this2));
    _this2.resetQuery = _this2.resetQuery.bind(_assertThisInitialized(_this2));
    _this2.changeDataDisplay = _this2.changeDataDisplay.bind(_assertThisInitialized(_this2));
    _this2.updateFilter = _this2.updateFilter.bind(_assertThisInitialized(_this2));
    return _this2;
  }
  ...
  _createClass(DataQueryApp, [{
    ...
    value: function componentDidMount() {
      ...
      $(domNode).find('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
        ...
        if (e.target) {
          e.target.classList.add('active'); // Both the <li> tag and the <a> tag should be active
    ...
    value: function saveCurrentQuery(name, shared, override) {
      ...
      $.post(loris.BaseURL + '/AjaxHelper.php?Module=dataquery&script=saveQuery.php', {
        ...
        var id = JSON.parse(data).id,
            queryIDs = _this4.state.queryIDs;
    ...
    value: function loadFilterRule(rule) {
      ...
      $.ajax({
        ...
        success: function success(data) {
          var i,
              allSessions = {},
              allCandiates = {}; // Loop through data and divide into individual visits with unique PSCIDs
    ...
    value: function fieldChange(fieldName, category, downloadable) {
      ...
      this.setState(function (state) {
        ...
        if (!selectedFields[category]) {
          ...
          selectedFields[category][fieldName] = JSON.parse(JSON.stringify(_this6.props.Visits)); // Add all visits to the given category, initializing their counts to 1
    ...
    key: "runQuery",
    value: function runQuery(fields, sessions) {
      var _this7 = this;
      ...
      for (var i = 0; i < fields.length; i += 1) {
        ...
        var category = field_split[0]; // Check if the current category has already been queried, if so skip
            ...
            success: function success(data) {
              if (data) {
                var _i3,
                    ...
                    rows,
                    identifier,
                    sessiondata = _this7.state.sessiondata;
    ...
    value: function getRowData(displayID) {
      ...
      if (displayID === 0) {
        ...
        var Visits = {},
            ...
            index,
            instrument,
            _fieldSplit; // Loop trough session data building the row identifiers and desired visits
    ...
    value: function render() {
      ...
      var tabs = [];
      var tabsNav = [];
      var alert = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null); // Add the info tab

      tabs.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(InfoTabPane, {
        key: "Info",
        TabId: "Info",
      ...
      tabs.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(FieldSelectTabPane, {
        key: "DefineFields",
        TabId: "DefineFields",
      ...
      tabs.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(FilterSelectTabPane, {
        key: "DefineFilters",
        TabId: "DefineFilters",
        categories: this.props.categories,
      ...
      tabs.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ViewDataTabPane, {
        key: "ViewData",
        TabId: "ViewData",
      ...
      tabs.push( /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(ManageSavedQueriesTabPane, {
        key: "SavedQueriesTab",
      ...
      var sideBar = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null); // Display the field sidebar for certain tabs
      ...
      if (this.state.fields.length > 0 && this.state.ActiveTab !== 'ViewData' && this.state.ActiveTab !== 'Statistics' && this.state.ActiveTab !== 'Info') {
        ...
        sideBar = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
          className: "col-md-2"
      ...
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, alert, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        href: "#DefineFields",
        "data-toggle": "tab"
      }, "Define Fields")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
        role: "presentation",
        onClick: this.onTabChangeHandler
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
        href: "#DefineFilters",
        "data-toggle": "tab"
      }, "Define Filters")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
        role: "presentation",
        onClick: this.onTabChangeHandler
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
        href: "#ViewData",
        "data-toggle": "tab"
      }, "View Data")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
        role: "presentation",
        onClick: this.onTabChangeHandler
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
        href: "#Statistics",
        "data-toggle": "tab"
      }, "Statistical Analysis"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(SavedQueriesList, {
        userQueries: this.state.queryIDs.User,
        globalQueries: this.state.queryIDs.Shared,
        queryDetails: this.state.savedQueries,
        queriesLoaded: this.state.queriesLoaded,
...
DataQueryApp.propTypes = {
  SavedQueries: prop_types__WEBPACK_IMPORTED_MODULE_1___default.a.array,
...
window.RDataQueryApp = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createFactory(DataQueryApp);
