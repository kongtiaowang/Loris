    ...
    render: function() {
        return (
        	<div>
                ...
                {/* BEGIN OVERRIDE        */}
                {/*-----------------------*/}
                <h3><span className="text-danger">&#129299;Remember to ALWAYS include variable “Participant Status” in the “Demographic” instrument to get information on excluded candidates. &#129299;&#128300;</span></h3>
                {/*-----------------------*/}
                {/* END OVERRIDE          */}
                {/*-----------------------*/}
