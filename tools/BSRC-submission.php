...
if (empty($argv[1])) {
    ...
    $TQ = array(
           "Mullen"                      => "SELECT s.Visit_label, c.IBISId AS id_number,
				...
				expressive_lang_27,
				expressive_lang_28,
				expressive_lang_basal,
				expressive_lang_ceiling,
				expressive_language_age_equivalent,
				expressive_language_description,
				expressive_language_percentile,
				expressive_language_raw,
				...
				fine_motor_basal,
				fine_motor_ceiling,
				fine_motor_description,
				fine_motor_percentile,
				fine_motor_raw,
				fine_motor_t,
				gross_motor_1,
				gross_motor_2,
				...
				gross_motor_34,
				gross_motor_35,
				gross_motor_age_equivalent,
				gross_motor_basal,
				gross_motor_ceiling,
				gross_motor_description,
				gross_motor_percentile,
				gross_motor_raw,
				gross_motor_t,
				other_comments,
				receptive_lang_1,
				...
				receptive_lang_32,
				receptive_lang_33,
				receptive_lang_basal,
				receptive_lang_ceiling,
				receptive_language_age_equivalent,
				receptive_language_description,
				receptive_language_percentile,
				receptive_language_raw,
				...
				visual_recept_33,
				visual_recept_basal,
				visual_recept_ceiling,
				visual_reception_age_equivalent,
				visual_reception_description,
				visual_reception_percentile,
				visual_reception_raw,
				visual_reception_t
                ...
                ORDER BY c.IBISId, s.Visit_label;",
           "Vineland"                    => "SELECT
           ...
           "Demographics"                => "SELECT DISTINCT c.IBISId AS id_number, 
                ...
                and fp.Test_name='adi_r_proband' and fp.CommentID not like 'DDE_%')
                LEFT JOIN adi_r_proband p ON (p.CommentID=fp.CommentID
           ...
           "SCQ"                         => "SELECT
                ...
                q12_interested_in_parts,
                q13_intense_interests,
