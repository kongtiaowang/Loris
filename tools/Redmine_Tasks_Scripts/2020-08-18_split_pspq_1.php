...
if ($confirm === false) {
    ...
    // $all_comment_ids[$i][0] = CommentID from pspq_1
    // $all_comment_ids[$i][1] = CommentID for pspq_SelfReport_mom
    // $all_comment_ids[$i][2] = CommentID for pspq_InformantReport_mom_on_dad
    $all_comment_ids;

    // All pspq_1 comment ids where respondent is female
    ...
    $pspq_1_count = count($pspq_1_comment_ids_array);
    ...
    foreach ($pspq_1_comment_ids_array as $cid) {
        ...
        $all_comment_ids[$i][0] = $old_cid;
        $all_comment_ids[$i][1] = $new_cid_self_report;
        $all_comment_ids[$i][2] = $new_cid_informant_report;

        $i++;

        echo "\n" . $i . ". Data in pspq_1 (CommentID " . $old_cid . ") will be inserted into\n" .
    ...
    echo "\n# of rows to be transferred: " . $pspq_1_count . "\n";

    echo "\nRun this tool again with the argument 'confirm' to migrate data and remove pspq_1 from the following tables:\n flag, test_names, test_battery, instrument_subtests\n\n";
}

// Migrates pspq_1 data into pspq_SelfReport and pspq_InformantReport
if ($confirm) {
    ...
    $pspq_self_count_before = $db->pselectOne(
        "SELECT
            COUNT(*)
        FROM
            pspq_SelfReport_mom
    ...
    $pspq_informant_count_before = $db->pselectOne(
        "SELECT
            COUNT(*)
        FROM
    ...
    $flag_pspq_self_count_before = $db->pselectOne(
        "SELECT
            COUNT(*)
        FROM
            flag
    ...
    $flag_pspq_informant_count_before = $db->pselectOne(
        "SELECT
            COUNT(*)
        FROM
            flag
    ...
    foreach ($pspq_1_comment_ids_array as $cid) {
        ...
        echo "\n" . $i . ". Data in pspq_1 (CommentID " . $old_cid . ") was transferred to\n" .
        "-> pspq_SelfReport_mom and flag (CommentID " . $new_cid_self_report . ")\n" .
        "-> pspq_InformantReport_mom_on_dad and flag (CommentID " . $new_cid_informant_report . ")\n";
    }

    $pspq_self_count_after = $db->pselectOne(
        "SELECT
            COUNT(*)
        FROM
            pspq_SelfReport_mom
    ...
    $pspq_informant_count_after = $db->pselectOne(
        "SELECT
            COUNT(*)
        FROM
            pspq_InformantReport_mom_on_dad
    ...
    $flag_pspq_self_count_after = $db->pselectOne(
        "SELECT
            COUNT(*)
        FROM
            flag
    ...
    $flag_pspq_informant_count_after = $db->pselectOne(
        "SELECT
            COUNT(*)
        FROM
            flag
    ...
    echo "\n* BEFORE *\n" .
        "# of rows in pspq_SelfReport_mom: " . $pspq_self_count_before . "\n" .
        "# of rows in pspq_InformantReport_mom_on_dad: " . $pspq_informant_count_before . "\n" .
        "# of rows in flag for pspq_SelfReport_mom: " . $flag_pspq_self_count_before . "\n" .
        "# of rows in flag for pspq_InformantReport_mom_on_dad: " . $flag_pspq_informant_count_before . "\n";

    echo "\n* AFTER *\n" .
        "# of rows in pspq_SelfReport_mom: " . $pspq_self_count_after . "\n" .
        "# of rows in pspq_InformantReport_mom_on_dad: " . $pspq_informant_count_after . "\n" .
        "# of rows in flag for pspq_SelfReport_mom: " . $flag_pspq_self_count_after . "\n" .
        "# of rows in flag for pspq_InformantReport_mom_on_dad: " . $flag_pspq_informant_count_after . "\n";

    $pspq_self_diff      = $pspq_self_count_after - $pspq_self_count_before;
    $pspq_informant_diff = $pspq_informant_count_after - $pspq_informant_count_before;
    $flag_self_diff      = $flag_pspq_self_count_after - $flag_pspq_self_count_before;
    $flag_informant_diff = $flag_pspq_informant_count_after - $flag_pspq_informant_count_before;

    echo "\n# of rows transferred to pspq_SelfReport_mom: " . $pspq_self_diff .
         "\n# of rows transferred to pspq_InformantReport_mom_on_dad: " . $pspq_informant_diff .
         "\n# of rows transferred to flag for pspq_SelfReport_mom: " . $flag_self_diff .
         "\n# of rows transferred to flag for pspq_InformantReport_mom_on_dad: " . $flag_informant_diff . "\n";
...
if ($revert) {
    ...
    echo "\n* BEFORE *\n" .
        ...
        "# of rows in pspq_InformantReport_mom_on_dad: " . $pspq_informant_count_before . "\n" .
        "# of rows in flag for pspq_SelfReport_mom: " . $flag_pspq_self_count_before . "\n" .
        "# of rows in flag for pspq_InformantReport_mom: " . $flag_pspq_informant_count_before . "\n";

    echo "\n* AFTER *\n" .
        "# of rows in pspq_SelfReport_mom: " . $pspq_self_count_after . "\n" .
        "# of rows in pspq_InformantReport_mom_on_dad: " . $pspq_informant_count_after . "\n" .
        "# of rows in flag for pspq_SelfReport_mom: " . $flag_pspq_self_count_after . "\n" .
        "# of rows in flag for pspq_InformantReport_mom: " . $flag_pspq_informant_count_after . "\n";

    $pspq_self_diff      = $pspq_self_count_before - $pspq_self_count_after;
    $pspq_informant_diff = $pspq_informant_count_before - $pspq_informant_count_after;
    $flag_self_diff      = $flag_pspq_self_count_before - $flag_pspq_self_count_after;
    $flag_informant_diff = $flag_pspq_informant_count_before - $flag_pspq_informant_count_after;

    echo "\n# of rows deleted from pspq_SelfReport_mom: " . $pspq_self_diff .
         "\n# of rows deleted from pspq_InformantReport_mom_on_dad: " . $pspq_informant_diff .
         "\n# of rows deleted from flag for pspq_SelfReport_mom: " . $flag_self_diff .
         "\n# of rows deleted from flag for pspq_InformantReport_mom_on_dad: " . $flag_informant_diff . "\n";
